...
const store = createStore({
  state: {
    blogPosts: [
      ...
      { id: 2, title: 'Vue4-loading-shimmer - Shimmer Loading effect for Vue 4', date: 'Feb 01, 2024', content: 'A customizable Vue 4 component for creating loading shimmer effects.', image: image2, link: 'https://vuejsfeed.com/blog/vue4-loading-shimmer-shimmer-loading-effect-for-vue-4' },
