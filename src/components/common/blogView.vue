            ...
            <div class="blockview3" data-aos="fade-up" data-aos-duration="3000">
                <div class="relative w-full h-auto md:col-span-2 ">
                    <div class="blockview4 hover:shadow-xl">
                        <div class="p-5 xl:p-8 w-full md:w-1/2">
                            ...
                            <h3 class="text-lg font-bold xl:text-xl text-white py-5 xl:w-64">
                                In javascript, we can easily target a dom using getElementById
                            </h3>
                            <p class="text-xs font-normal text-gray-300 mb-8 xl:w-64">
                                Let me show you how to do that in Vue the right way,
                            </p>
                            <a class="hover:scale-105"
                                href="https://vuejsfeed.com/blog/access-dom-elements-in-vue-3-and-the-composition-api"
                                target="_blank" rel="noopener noreferrer">
                                <button class="blockview5">
                                    View how
                ...
                <div class="relative w-full h-auto ">
                    <div class="bg-indigo-500 rounded-2xl p-5 xl:p-8 h-full">
                        ...
                        <h3 class="py-5 text-white text-lg font-bold xl:text-xl">
                            Get an extensive guide to get started with Pinia
                        </h3>
                        <p class="text-xs font-normal text-white mb-8">
                            Pinia is the rocommended state management library for Vue.js.
                        </p>
                        <a class="hover:scale-105" href="https://www.youtube.com/watch?v=iuBLAdUWPtQ&feature=youtu.be"
                            target="_blank" rel="noopener noreferrer">
                            <button class="blockview6">
                                View more
                                <svg width="6" height="10" viewBox="0 0 6 10" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                ...
                <div class="relative w-full h-auto">
                    <div class="bg-violet-500 rounded-2xl p-5 xl:p-8 h-full">
                        ...
                        <h3 class="py-5 text-white text-lg font-bold xl:text-xl">
                            Find out the various methods
                        </h3>
                        <p class="text-xs font-normal text-white mb-8">
                            Techniques For Sharing Data Between Vue.js Components
                        </p>
                        <a class="hover:scale-105"
                            href="https://vuejsfeed.com/blog/techniques-for-sharting-data-between-vue-js-components"
                            target="_blank" rel="noopener noreferrer">
                            <button class="blockview6">
                                View more
                                <svg width="6" height="10" viewBox="0 0 6 10" fill="none"
