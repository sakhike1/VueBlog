  ...
  <div class="font-[sans-serif] text-[#333] bg-gray-180" data-aos="fade-up" data-aos-duration="3000">
    <div class="min-h-screen flex flex-col items-center justify-center">
      <div
          ...
          <form @submit.prevent="submitLogin">
            <div class="mb-12">
              ...
              <p class="text-sm mt-4 ">Don't have an account <router-link to="/registerView"
                  class="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Register here</router-link>
              </p>
            </div>
            <div>
        ...
        <div class="md:h-full max-md:mt-10 bg-gradient-to-r from-blue-700 via-blue-800 to-gray-900 lg:p-12 p-8">
