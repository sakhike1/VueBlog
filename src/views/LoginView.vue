  ...
  <div class="font-[sans-serif] text-[#333] bg-gray-180" data-aos="fade-up" data-aos-duration="3000">
    <div class="min-h-screen flex flex-col items-center justify-center">
      <div
        ...
        <div class="md:max-w-md w-full sm:px-6 py-4">
          <form>
            <div class="mb-12">
              ...
              <p class="text-sm mt-4 ">Don't have an account <a href="javascript:void(0);"
        ...
        <div class="md:h-full max-md:mt-10 bg-gradient-to-r from-gray-700 via-gray-900 to-black lg:p-12 p-8">
